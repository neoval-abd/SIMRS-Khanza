...
public final class RMPenilaianAwalMedisRalanPsikiatrik extends javax.swing.JDialog {
    ...
    */
    ...
    private void isRawat() {
        ...
        if (Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat='" + TNoRw.getText() + "' ") > 0) {
            
            Suhu.setText(Sequel.cariIsi("select suhu from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
            TD.setText(Sequel.cariIsi("select td from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
            Nadi.setText(Sequel.cariIsi("select nadi from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
            RR.setText(Sequel.cariIsi("select rr from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
            TB.setText(Sequel.cariIsi("select tb from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
            BB.setText(Sequel.cariIsi("select bb from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
            GCS.setText(Sequel.cariIsi("select gcs from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
            
            KeluhanUtama.setText(Sequel.cariIsi("select keluhan_utama from penilaian_awal_keperawatan_ralan_psikiatri where no_rawat=?", TNoRw.getText()));
