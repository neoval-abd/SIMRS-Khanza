...
public class MasterTemplateSOAPIEPerawat extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MasterTemplateSOAPIEPerawat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row = {"No.Template", "Subyek", "Obyek", "Asesmen", "Planning", "Instruksi", "Evaluasi"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Master Template SOAPIE Perawat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            Valid.hapusTable(tabMode, Kd, "template_soapie_perawat", "no_template");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().equals("")) {
            ...
            Valid.editTable(tabMode, "template_soapie_perawat", "no_template", "?", "no_template=?,keluhan=?,pemeriksaan=?,penilaian=?,rencana=?,instruksi=?,evaluasi=?", 8, new String[]{
                Kd.getText(), Keluhan.getText(), Pemeriksaan.getText(), Penilaian.getText(), Rencana.getText(),
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTemplateSOAPIEPerawat dialog = new MasterTemplateSOAPIEPerawat(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select template_soapie_perawat.no_template,"
                    + "template_soapie_perawat.keluhan,template_soapie_perawat.pemeriksaan,template_soapie_perawat.penilaian,"
                    + "template_soapie_perawat.rencana,template_soapie_perawat.instruksi,template_soapie_perawat.evaluasi from template_soapie_perawat "
                    + "where template_soapie_perawat.no_template like ? or template_soapie_perawat.penilaian like ? or "
                    + "template_soapie_perawat.pemeriksaan like ? order by template_soapie_perawat.no_template");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        rs.getString("no_template"), rs.getString("keluhan"), rs.getString("pemeriksaan"), rs.getString("penilaian"),
    ...
    public void emptTeks() {
        Kd.setText("");
        Valid.autoNomer("template_soapie_perawat", "S", 4, Kd);
        TabRawat.setSelectedIndex(0);
        Keluhan.setText("");
        Pemeriksaan.setText("");
        Penilaian.setText("");
    ...
    private void getData() {
        if (tbDokter.getSelectedRow() != -1) {
            ...
            Keluhan.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 1).toString());
            Pemeriksaan.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 2).toString());
            Penilaian.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 3).toString());
            Rencana.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 4).toString());
            Instruksi.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 5).toString());
            Evaluasi.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 6).toString());
        }
    }
