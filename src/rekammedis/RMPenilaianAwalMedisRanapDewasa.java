...
<<<<<<< HEAD
        ...
        try {
            System.out.println("NO RAWAT RANAP = "+TNoRw.getText());

            ps = koneksi.prepareStatement(
                "select pemeriksaan_suhu,pemeriksaan_td,pemeriksaan_nadi,pemeriksaan_rr," +
                "pemeriksaan_tb,pemeriksaan_bb,rpk,rpo,rps,rpd " +
                "from penilaian_awal_keperawatan_ranap where no_rawat=?"
            );
            ...
            if (rs.next()) {
                ...
                Suhu.setText(rs.getString("pemeriksaan_suhu"));
                TD.setText(rs.getString("pemeriksaan_td"));
                Nadi.setText(rs.getString("pemeriksaan_nadi"));
                RR.setText(rs.getString("pemeriksaan_rr"));
                TB.setText(rs.getString("pemeriksaan_tb"));
                BB.setText(rs.getString("pemeriksaan_bb"));
