...
<<<<<<< HEAD
        ...
        if (Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_kebidanan where no_rawat='" + TNoRw.getText() + "' ") > 0) {
            ...
            // RPK.setText(Sequel.cariIsi("select rpk from penilaian_awal_keperawatan_kebidanan where no_rawat=?", TNoRw.getText()));
            ...
            TFU.setText(Sequel.cariIsi("select tfu from penilaian_awal_keperawatan_kebidanan where no_rawat=?", TNoRw.getText()));
