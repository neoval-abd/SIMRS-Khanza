    ...
    */
    ...
    private void isRawat() {
        ...
        if (Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat='" + TNoRw.getText() + "' ") > 0) {
            Suhu.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_suhu from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            TD.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_td from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            BB.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_bb from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            TB.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_tb from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            Nadi.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_nadi from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            RR.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_rr from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            GCS.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_gcs from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            KeluhanUtama.setText(Sequel.cariIsi("select keluhan from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            RPK.setText(Sequel.cariIsi("select rpk from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
            // RPO.setText(Sequel.cariIsi("select rpo from penilaian_awal_keperawatan_kebidanan where no_rawat=?", TNoRw.getText()));
            // RPS.setText(Sequel.cariIsi("select rps from penilaian_awal_keperawatan_kebidanan where no_rawat=?", TNoRw.getText()));
            // RPD.setText(Sequel.cariIsi("select rpd from penilaian_awal_keperawatan_kebidanan where no_rawat=?", TNoRw.getText()));
            // Alergi.setText(Sequel.cariIsi("select alergi from penilaian_awal_keperawatan_kebidanan where no_rawat=?", TNoRw.getText()));
            
            TFU.setText(Sequel.cariIsi("select pemeriksaan_kebidanan_tfu from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=?", TNoRw.getText()));
