...
<<<<<<< HEAD
        ...
        if (Sequel.cariInteger("select count(no_rawat) from penilaian_medis_igd where no_rawat='" + TNoRw.getText() + "' ") > 0) {
            ...
            RRSebelumTransfer.setText(Sequel.cariIsi("select pernapasan from data_triase_igd where no_rawat=?", TNoRw.getText()));
       ...
       // TAMBAHAN AMBIL DARI PENILAIAN AWAL KEPERAWATAN RALAN
        else if (Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_ralan where no_rawat='" + TNoRw.getText() + "' ") > 0) {
            SuhuSebelumTransfer.setText(Sequel.cariIsi("select suhu from penilaian_awal_keperawatan_ralan where no_rawat=?", TNoRw.getText()));
            TDSebelumTransfer.setText(Sequel.cariIsi("select td from penilaian_awal_keperawatan_ralan where no_rawat=?", TNoRw.getText()));
            NadiSebelumTransfer.setText(Sequel.cariIsi("select nadi from penilaian_awal_keperawatan_ralan where no_rawat=?", TNoRw.getText()));
