    ...
    */
    ...
    private void isRawat() {
        ...
        if (Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_ralan_geriatri where no_rawat='" + TNoRw.getText() + "' ") > 0) {
            ...
            // BB.setText(Sequel.cariIsi("select bb from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?", TNoRw.getText()));
            // TB.setText(Sequel.cariIsi("select tb from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?", TNoRw.getText()));
            ...
            // GCS.setText(Sequel.cariIsi("select gcs from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?", TNoRw.getText()));
            ...
            //RPK.setText(Sequel.cariIsi("select rpk from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?", TNoRw.getText()));
            RPO.setText(Sequel.cariIsi("select rpo from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?", TNoRw.getText()));
            RPS.setText(Sequel.cariIsi("select rps from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?", TNoRw.getText()));
