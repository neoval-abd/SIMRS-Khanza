...
// TAMBAHAN FITRU PINTASAN PENUNJANG
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    // FITUR TAMBAHAN PRIVATE TEMPLATE SOAPIE
    ...
    // TAMBAHAN FITUR KOMUNIKASI SBAR
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        // AKHIR TAMBAHAN FITUR KOMUNIKASI SBAR
        ...
        // TAMBAHAN FITUR TEMPLATE SOAPIE
...
//        BtnVerifSbar1.setBounds(460, 50, 28, 23);
        ...
        // TAMBAHAN FITUR KOMUNIKASI SBAR DI BUTTON
        ...
        BtnVerifSbar1.setMnemonic('4');
        BtnVerifSbar1.setToolTipText("ALt+4");
        BtnVerifSbar1.setName("BtnVerifSbar"); // NOI18N
        BtnVerifSbar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifSbarActionPerformed(evt);
            }
        ...
        BtnVerifSbar1.setBounds(920, 50, 28, 23);
        ...
        BtnTemplateResep1.setBounds(930, 50, 160, 26);

        BtnPintasanResume.setForeground(new java.awt.Color(0, 0, 0));
        BtnPintasanResume.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnPintasanResume.setMnemonic('4');
        BtnPintasanResume.setText("Resume Pasien");
        BtnPintasanResume.setToolTipText("");
        BtnPintasanResume.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPintasanResume.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnPintasanResume.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPintasanResume.setName("BtnPintasanResume"); // NOI18N
        BtnPintasanResume.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPintasanResumeActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPintasanResume);
        BtnPintasanResume.setBounds(930, 80, 160, 26);
        ...
        BtnHasilRadiologi.setGlassColor(new java.awt.Color(0, 255, 0));
        ...
        BtnHasilRadiologi.setBounds(930, 130, 160, 26);

        // TAMBAHAN FITUR PINTASAN RIWAYAT PENGOBATAN
        ...
        BtnHasilPengobatan.setBounds(930, 160, 160, 26);

        // TAMBAHAN FITUR PINTASAN RIWAYAT OPERASI
        ...
        BtnHasilPengobatan1.setBounds(930, 190, 160, 26);

        // TAMBAHAN FITUR PINTASAN PERMINTAAN PENUNJANG
        ...
        BtnInputLAB.setBounds(1100, 50, 160, 26);
        ...
        BtnInputRAD.setBounds(1100, 80, 160, 26);
        ...
        BtnBalanceCairan1.setBounds(930, 220, 160, 26);
        ...
        // TAMBAHAN FITUR PANGGIL PASIEN
        BtnPanggilPasien = new widget.Button();
        BtnPanggilPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/panggil.png"))); // NOI18N
        ...
        BtnPanggilPasien.setGlassColor(new java.awt.Color(144, 238, 144));
...
//        }
        ...
        //TAMBAHAN FITRU KOMUNIKASI SBAR
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            Valid.textKosong(TNoRw, "No.Rawat");
        } else {
                        ...
                        if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                            ...
                            if (akses.getkode().equals("Admin Utama")) {
                                if (Sequel.menyimpantf("pemeriksaan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 21, new String[]{
                                    ...
                                    // TAMBAHAN SIMPAN UNTUK TEMPLATE
    ...
    // AWAL FITUR TAMBAHAN KOMUNIKASI SBAR
...
//    }//GEN-LAST:event_BtnVerifSbar1ActionPerformed
    // AKHIR TAMBAHAN FITUR KOMUNIKASI SBAR FUNGSI
    ...
    private widget.Button BtnSkorBromagePascaAnestesi, BtnPenilaianPreInduksi, BtnHasilPemeriksaanUSGUrologi, BtnHasilPemeriksaanUSGGynecologi,
            BtnHasilPemeriksaanEKG, BtnPenatalaksanaanTerapiOkupasi, BtnPenilaianPsikolog, BtnHasilPemeriksaanUSGNeonatus, BtnHasilEndoskopiFaringLaring,
            ...
            BtnSkriningRisikoKankerPayudara, BtnSkriningRisikoKankerParu, BtnSkriningKesehatanGigiMulutremaja, BtnSkriningTBC, BtnCatatanAnastesiSedasi, BtnSkriningPUMA,
            BtnSkriningAdiksiNikotin, BtnSkriningThalassemia, BtnSkriningInstrumenSDQ, BtnSkriningInstrumenSRQ, BtnChecklistPemberianFibrinolitik, BtnSkriningKankerKolorektal,
            BtnPenilaianPsikologKlinis, BtnPenilaianDerajatDehidrasi, BtnHasilPemeriksaanECHO, BtnPenilaianBayiBaruLahir, BtnSkriningDiabetesMelitus, BtnLaporanTindakan,
            BtnPelaksanaanInformasiEdukasi, BtnLayananKedokteranFisikRehabilitasi, BtnSkriningKesehatanGigiMulutBalita, BtnSkriningAnemia, BtnSkriningHipertensi,
            BtnSkriningKesehatanPenglihatan, BtnCatatanObservasiHemodialisa, BtnSkriningKesehatanGigiMulutDewasa, BtnSkriningRisikoKankerServiks, BtnCatatanCairanHemodialisa,
            BtnSkriningKesehatanGigiMulutLansia, BtnSkriningIndraPendengaran, BtnCatatanPengkajianPaskaOperasi, BtnSkriningFrailtySyndrome, BtnCatatanObservasiBayi,
            BtnChecklistKesiapanAnestesi, BtnHasilPemeriksaanSlitLamp, BtnHasilPemeriksaanOCT, BtnSkriningInstrumenACRS, BtnChecklistKriteriaMasukNICU,
            BtnChecklistKriteriaMasukPICU, BtnSkriningInstrumenMentalEmosional, BtnSkriningInstrumenAMT,
            // TAMBAHAN DARI upstream
            BtnSkriningPneumoniaSeverityIndex, BtnAwalMedisJantung, BtnAwalMedisUrologi, BtnHasilPemeriksaanTreadmill, BtnHasilPemeriksaanECHOPediatrik, BtnSkriningCURB65, BtnSkriningGiziKehamilan;
    private javax.swing.JPopupMenu PopupSOAP;
    private javax.swing.JMenuItem MnSOAPDokter, MnSOAPPetugas;
    // TAMBAHAN SENDIRI
    private widget.Button BtnSoapDokter, BtnSoapDokter1, BtnPanggilPasien;

    // TAMBAHAN FITUR DI PRIVATE
    ...
    private widget.Button BtnPintasanResume;
...
//        }
    ...
    // TAMBAHAN FITUR TEMPLATE SOAPIE PRIVATE VOID
    ...
    private void SimpanTemplateSOAPIEPerawat() {
        if (ChkTemplatePerawat.isSelected()) {
    ...
    // AKHIR TAMBAHAN FITUR PRIVATE VOID

    // TAMBAHAN FITUR DI PRIVATE VOID
    private void TCariActionPerformedPemeriksaan(java.awt.event.ActionEvent evt) {
        ...
        BtnChecklistKriteriaMasukNICU.setVisible("check list kriteria masuk nicu".toLowerCase().contains(cari));
        BtnChecklistKriteriaMasukPICU.setVisible("check list kriteria masuk picu".toLowerCase().contains(cari));
        BtnSkriningInstrumenACRS.setVisible("skrining instrumen acrs".toLowerCase().contains(cari));
        BtnSkriningInstrumenMentalEmosional.setVisible("skrining instrumen mental emosional".toLowerCase().contains(cari));
        BtnSkriningInstrumenAMT.setVisible("skrining instrumen amt".toLowerCase().contains(cari));

        BtnAwalMedisJantung.setVisible("awal medis jantung".toLowerCase().contains(cari));
        BtnAwalMedisUrologi.setVisible("awal medis urologi".toLowerCase().contains(cari));
        BtnHasilPemeriksaanECHOPediatrik.setVisible("hasil echo pediatrik".toLowerCase().contains(cari));
        BtnHasilPemeriksaanTreadmill.setVisible("hasil pemeriksaan treadmill".toLowerCase().contains(cari));
        BtnSkriningPneumoniaSeverityIndex.setVisible("skrining psi".toLowerCase().contains(cari));
        BtnSkriningCURB65.setVisible("skrining curb-65".toLowerCase().contains(cari));

        FormMenu.revalidate();
        FormMenu.repaint();
    }

    // TAMBAHAN FITUR KOMUNIKASI SBAR PRIVATE VOID
    ...
    // AKHIR TAMBAHAN FITUR SBAR PRIVATE VOID
    ...
    // TAMBAHAN FITUR PINTASAN PENUNJANG
    ...
    private void BtnPintasanResumeActionPerformed(java.awt.event.ActionEvent evt) {
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
