...
// TAMBAHAN SENDIRI KOMUNIKASI SBAR
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        // TAMABAHAN FITUR KOMUNIKASI SBAR INPUT PEGAWAI/DOKTER
...
//        });
        ...
        // TAMBAHAN FITRU TEMPLATE SOAPIE
...
//        PanelInput5.add(panelGlass17, java.awt.BorderLayout.CENTER);
        ...
        jLabel10.setPreferredSize(new java.awt.Dimension(23, 23));
        jLabel10.setText("");
        ...
        BtnBalanceCairan1.setBounds(930, 180, 160, 26);
        ...
        BtnHasilRadiologi.setBounds(930, 90, 160, 26);
        ...
        BtnHasilPengobatan.setBounds(930, 120, 160, 26);
        ...
        BtnHasilPengobatan1.setBounds(930, 150, 160, 26);
                        ...
                        if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                            ...
                            if (akses.getkode().equals("Admin Utama")) {
                                if (Sequel.menyimpantf("pemeriksaan_ranap", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 20, new String[]{
                                    ...
                                    // TAMBAHAN SIMPAN TEMPLATE SOAPIE
...
//            form.tampil();
    ...
    private widget.Button BtnSoapDokter, BtnSoapPerawat, BtnSkorBromagePascaAnestesi, BtnPenilaianPreInduksi, BtnHasilPemeriksaanUSGUrologi, BtnHasilPemeriksaanUSGGynecologi, BtnHasilPemeriksaanEKG, BtnHasilPemeriksaanUSGNeonatus, BtnHasilEndoskopiFaringLaring, BtnHasilEndoskopiHidung, BtnHasilEndoskopiTelinga,
            ...
            BtnChecklistKriteriaMasukNICU, BtnChecklistKriteriaKeluarNICU, BtnAwalMedisPsikiatri, BtnChecklistKriteriaMasukPICU, BtnChecklistKriteriaKeluarPICU, BtnHasilPemeriksaanTreadmill, BtnHasilPemeriksaanECHOPediatrik, BtnAwalMedisJantung, BtnSkriningGiziKehamilan;
    ...
    private void initRawatInap() {
        ...
        //AWAL TAMBAHAN FITUR TEMPLATE SOAPIE
        ...
        BtnSoapPerawat.setGlassColor(new java.awt.Color(144, 238, 144));
        ...
        // AKHIR TAMBAHAN FITUR TEMPLATE SOAPIE
    ...
    // TAMBAHAN FITUR TCARIPEMERIKSAAN DI PRIVATE VOID
    // TAMBAHAN FITUR TCARIPEMERIKSAAN RANAP
    private void TCariActionPerformedPemeriksaan(java.awt.event.ActionEvent evt) {
        ...
        BtnChecklistKriteriaMasukNICU.setVisible("check list kriteria masuk nicu".contains(cari));
        BtnChecklistKriteriaKeluarNICU.setVisible("check list kriteria keluar nicu".contains(cari));
        BtnChecklistKriteriaMasukPICU.setVisible("check list kriteria masuk picu".contains(cari));
        BtnChecklistKriteriaKeluarPICU.setVisible("check list kriteria keluar picu".contains(cari));
    ...
    // TAMBAHAN PAKET UNTUK PEMERIKSAAN
    // AWAL TAMBAHAN FITUR SOAPIE
    private void BtnSoapPerawatActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    // TAMBAHAN FITUR KOMUNIKASI SBAR DAY 2
...
//    }//GEN-LAST:event_tbPemeriksaanTbakKeyReleased
    ...
    // TAMBAHAN FITUR KOMUNIKASI SBAR TAPI SOAP
